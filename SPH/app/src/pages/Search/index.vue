              ...
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="changeOrder('1')">
                  <a
                    >综合<span
                      :class="{
                        'iconfont icon-UP': isAsc,
                        'iconfont icon-DOWN': isDesc,
                      }"
                      v-show="isOne"
                    ></span
                  ></a>
...
export default {
  ...
  computed: {
    ...
    isTwo() {
      return this.searchParams.order.split(":")[0] == 2 ? true : false;
    },
    isAsc() {
      return this.searchParams.order.split(":")[1] == "asc" ? true : false;
    },
    isDesc() {
      return this.searchParams.order.split(":")[1] == "desc" ? true : false;
    },
    ...mapState({
  ...
  mounted() {
    this.getData();
    // console.log(this.isAsc, this.isDesc);
  },
  methods: {
    getData() {
    ...
    getAttrInfo(attr, aval) {
      let props = `${attr.attrId}:${attr.attrName}:${aval}`;
