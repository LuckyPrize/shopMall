        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl
                v-for="baseSaleAttr in spuSaleAttrList"
                :key="baseSaleAttr.id"
              >
                <dt class="title">{{ baseSaleAttr.saleAttrName }}</dt>
                <dd
                  changepirce="0"
                  :class="{ active: attrValue.isChecked == 1 }"
                  v-for="attrValue in baseSaleAttr.spuSaleAttrValueList"
                  :key="attrValue.id"
                  @click="
                    changeIsCheck(attrValue, baseSaleAttr.spuSaleAttrValueList)
                  "
                >
...
export default {
  ...
  mounted() {
    ...
    // console.log(this.skuid);
    this.$store.dispatch("detail/getDetailInfo", this.skuid);
    // console.log(this.skuInfo, 2222);
    // console.log(this.categoryView, 1111);
    // console.log(this.skuImageList, 3333);

    // console.log(this.$store.getters);
  },
  methods: {
    changeIsCheck(attrVal, attrList) {
